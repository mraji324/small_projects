...
// Sample shopping sections and items
const shoppingSections = {
  groceries: ['Milk', 'Bread', 'Eggs', 'Fruits'],
  clothes: ['T-shirt', 'Jeans', 'Jacket', 'Sweater'],
  fashions: ['Handbag', 'Sunglasses', 'Watch', 'Necklace'],
...
app.get('/dashboard', authMiddleware, (req, res) => {
  res.render('dashboard', { user: req.session.user, shoppingSections });
});
